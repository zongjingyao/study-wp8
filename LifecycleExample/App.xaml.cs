...
using LifecycleExample.Resources;
...
namespace LifecycleExample
{
    public partial class App : Application
    {
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            {
                Debug.WriteLine("应用程序从休眠中激活...");
                PhoneApplicationService.Current.State["log"] += "应用程序从休眠中激活...\n";
            }
            else
            {
                Debug.WriteLine("应用程序从墓碑中激活...");
                PhoneApplicationService.Current.State["log"] += "应用程序从墓碑中激活...\n";
            }
        }
        ...
        {
            Debug.WriteLine("应用程序失效...");
            PhoneApplicationService.Current.State["log"] += "应用程序失效...\n";
        }
        ...
        {
            Debug.WriteLine("应用程序关闭...");
            PhoneApplicationService.Current.State["log"] += "应用程序关闭...\n";
        }
